...
namespace CarManufacturer
{
    class Car
    {
        ...
        public double TiresPressureSum()
        {
            return this.Tires[0].Pressure + this.Tires[1].Pressure +
                this.Tires[2].Pressure+ this.Tires[3].Pressure;
        }

        public void SpecialCarPrint()
        {
